  ...
  return (
    <div className="h-screen flex flex-col bg-zinc-100 w-full">
      ...
      <div className="flex flex-1 overflow-hidden w-full">
        ...
        <div className="w-64 bg-white border-r border-zinc-200 p-4 overflow-y-auto shadow-sm shrink-0">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden bg-zinc-100 p-4">
          <div className="min-h-full bg-white shadow-2xl border border-zinc-200 rounded-xl w-full overflow-x-hidden">
            {sections.length === 0 ? (
        ...
        {selectedSection && (
          <div className="w-80 bg-white border-l border-zinc-200 p-4 overflow-y-auto shadow-sm shrink-0">
